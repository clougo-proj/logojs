...
export default {
    "create": function(logo, sys) {
        ...
        function primitiveArray(size, origin = logo.type.ARRAY_DEFAULT_ORIGIN) {
            logo.type.validateInputArraySize(size);
        ...
        function primitivePick(data) {
            ...
            logo.type.throwIf(count == 0, logo.type.LogoException.INVALID_INPUT, data);
        ...
        function primitiveDsetfirst(list, value) {
            logo.type.validateInputNonEmptyList(list);
        ...
        function primitiveQueue(queueName, thing) {
            ...
            logo.type.validateInputList(queue);
        ...
        function primitiveSetitem(index, array, val) {
            logo.type.throwIf(logo.type.contains(val, array), logo.type.LogoException.INVALID_INPUT, val);
